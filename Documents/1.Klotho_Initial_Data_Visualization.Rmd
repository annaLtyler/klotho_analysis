...
rank.normalize.expression = FALSE

get.enrichments = FALSE #this allows us to turn of gprofiler code when gprofiler is down or we are offline
```
...
if(rank.normalize.expression){final.params = FALSE}
...
if(rank.normalize.expression){
  scaled.expr <- t(apply(scaled.expr, 1, rankZ))
}
